    ...
    <div v-if="vault">
        <div class="container">
            <div class="background-wrapper">
                <section class="heroImg row justify-content-center p-3 text-center" :style="{ backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0.7) 100%), url(${vault.img})` }">
